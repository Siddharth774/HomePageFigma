...
import { cardTopData } from "../data/data";
import CardBottom from "./CardBottom";
const Home = () => {
  const bottomCard = [1, 2, 3];
  return (
      ...
      <div className="home-container">
        ...
        <div className="home-top1">
          <div className="top1">
            ...
            <span className="pr-5">Last Updated - Februaru 22, 2020</span>
            <span className="pr-2 mt-1">
              <svg
                width="20"
                height="20"
        ...
        <div className="home-top2">
          <div>
            <span className="pr-20">Tools</span>
            <span className="pr-20">AWS Builder</span>
            <span className="pr-20">Start Build</span>
            <span className="pr-20">Build Supplies</span>
            <span className="pr-20">Tooling</span>
        ...
        <div className="home-top3">
          <div>
            <span className="pr-3">
              Home<span className="pl-3 text-md">&gt;</span>
            </span>
            <span className="pr-3">
              Hosting for all<span className="pl-3 text-md">&gt;</span>
            </span>
            <span className="pr-3">
              Hosting<span className="pl-3 text-md">&gt;</span>
            </span>
            <span className="pr-3">
              Hosting6<span className="pl-3 text-md">&gt;</span>
            </span>
            <span>Hosting5</span>
          </div>
        </div>
